...
const createCombine = async (req, res) => {
  try {
...
const getCombines = async (req, res) => {
  try {
...
// Get combine details
const getCombineDetails = async (req, res) => {
  try {
...
const getCombineBalances = async (req, res) => {
  try {
    const combine = await Combine.findById(req.params.combineId)
      .populate('expenses')
...
const settleOptimized = async (req, res) => {
  try {
    const combine = await Combine.findById(req.params.combineId)
      .populate('expenses')
